...
admin.site.register(School_documents_downloads)
admin.site.register(School_general_information)
admin.site.register(Form_one_news_portal)
admin.site.register(Form_two_news_portal)
admin.site.register(Form_three_news_portal)
admin.site.register(Form_four_news_portal)
admin.site.register(School_alumnae)
admin.site.register(School_updates)
admin.site.register(School_admission)
admin.site.register(School_rules)
